 ...
 * Description: Write a program that obtains the execution time of selection sort, radix sort, 
 * bubble sort, merge sort, quick sort, and heap sort for input size 
...
public class ExecutionTime {
	...
	public static void main(String[] args) {
		  System.out.print("|Array size    |Selection Sort|Radix Sort    |Bubble Sort   |Merge Sort    |Quick Sort    |Heap Sort     |");
